...
function Connection(connectionOptions, queueOptions, exchangeOptions){
	this.connectionOptions = _.defaultsDeep(connectionOptions || {}, {
		host: '127.0.0.1',
		port: 5672,
	...
	this.queueOptions = _.defaultsDeep(queueOptions || {}, {
		defaultExchangeName: '',
		reconnect: true,
	...
	this.exchangeOptions = _.defaultsDeep(exchangeOptions || {}, {
		name: 'queue-exchange',
		passive: false,
		durable: true,
		autoDelete: true,
